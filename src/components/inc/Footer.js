      ...
      <div>
        <footer style={{ backgroundColor: "#1f1f1f" }}>
          <div className="container text-center">
            <div className=" pt-5 pb-5 row justify-items-around text-center align-items-center">
              <div className="col-12">
                <a href="mailto:maksim.momcilovic@stud.altekanti.ch"
            ...
            <p class="copyright pb-5">Maksim Momcilovic © 2022 - All Rights Reserved.</p>
